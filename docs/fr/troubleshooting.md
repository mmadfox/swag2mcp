...
- **Windows PowerShell 5.1 :** La TUI peut afficher les champs de saisie sur une nouvelle ligne. Utilisez **Windows Terminal** ou le **terminal VS Code** — ils gèrent correctement le mode raw.
