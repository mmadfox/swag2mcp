...
- **Effet :** Lorsqu'il est `true`, swag2mcp démarre des serveurs de simulation pour les spécifications qui ont `base_mock_url` configuré. Les collections sans `base_mock_url` sont ignorées.
