...
> Не рекомендуется для обычного использования. Этот режим предназначен для тех, кто не знаком с YAML. Написание конфигурационного файла напрямую — быстрее и надёжнее.
