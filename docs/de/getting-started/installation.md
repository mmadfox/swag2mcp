...
Der Container läuft als nicht-root Benutzer und benötigt Zugriff auf Ihr Arbeitsverzeichnis. Mounten Sie `~/.swag2mcp` (oder Ihren benutzerdefinierten Pfad) nach `/home/nonroot/.swag2mcp`:
