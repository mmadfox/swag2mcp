...
Monte `~/.swag2mcp` (o su ruta personalizada) en `/home/nonroot/.swag2mcp`. El entrypoint ajusta automáticamente los permisos de archivos para que el contenedor pueda leer su espacio de trabajo.
