...
> Not recommended for regular use. This mode is intended for users who are not familiar with YAML. Writing the config file directly is faster and more reliable.
